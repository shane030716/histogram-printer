 ...
 * 1. printHistogram(int[] arr)
 * Example: input [1,0,0,0,6,0,0,3,10,2,3,4,5,0,3,0]
 * Output: 
 *                                  ___                            
 *                                 |   |                           
 *                                 |   |                           
 ...
 *   
 * 2. printWaterFilledHistogram(int[] arr)
 ...
 *   1   0   0   0   6   0   0   3  10   2   3   4   5   0   3   0
 *   
 * 3. printLargestRectangleFilledHistogram(int[] arr)
...
//		System.out.println();
	...
	public static void main(String[] args) {
		int[] arr = new int[] {1,0,0,0,6,0,0,3,10,2,3,4,5,0,3,0};
